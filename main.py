# -------------------------------------------------------------------------------
import pandas as pd
from corvus import generateCorvus, drawLine, searchCorvus, showReport, exportErrors
...
DROP_EXT = ['.md','.gitignore','.meteorignore','.yaml','.id','.pack','.idx',
            '.finished-upgraders','.env','.sh','.yml','.sample']
...
# print search report
STATS = showReport(df, dirs, errorLog, report, DESCRIPTION, PARTS=[True, True, True])
if False:
